...
function pingAdSpace(adSpaceId){
    if(isNaN(adSpaceId))return;
    let url = 'https://testnets.tableland.network/query?s=SELECT%20true%20FROM%20AdSpaces_420_141%20WHERE%20adspace_id%20=%20'+adSpaceId;
    ...
    .then((out) => {
        ...
        if(Array.isArray(out)){
            ...
            let latestAdsURL = `https://testnets.tableland.network/query?s=SELECT%20AdSpaces_420_141.size,Campaigns_420_142.cid,Campaigns_420_142.link%20FROM%20Deals_420_143%20JOIN%20Campaigns_420_142%20JOIN%20AdSpaces_420_141%20WHERE%20adspace_id%20=%20adspace_id_fk%20AND%20campaign_id%20=%20campaign_id_fk%20AND%20adspace_id%20=%20${adSpaceId}%20ORDER%20BY%20Deals_420_143.started_at%20DESC%20LIMIT%201`
            fetch(latestAdsURL)
            .then(res => res.json())
            .then((adToLoad) => {
